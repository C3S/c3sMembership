...
def upgrade():
    ...
    op.add_column('members', sa.Column('dues15_amount', DatabaseDecimal(length=12, collation=2), nullable=True))
    op.add_column('members', sa.Column('dues15_amount_paid', DatabaseDecimal(length=12, collation=2), nullable=True))
    op.add_column('members', sa.Column('dues15_amount_reduced', DatabaseDecimal(length=12, collation=2), nullable=True))
    op.add_column('members', sa.Column('dues15_balance', DatabaseDecimal(length=12, collation=2), nullable=True))
    op.add_column('members', sa.Column('dues15_balanced', sa.Boolean(), nullable=True))
    op.add_column('members', sa.Column('dues15_invoice', sa.Boolean(), nullable=True))
    op.add_column('members', sa.Column('dues15_invoice_date', sa.DateTime(), nullable=True))
    op.add_column('members', sa.Column('dues15_invoice_no', sa.Integer(), nullable=True))
    op.add_column('members', sa.Column('dues15_paid', sa.Boolean(), nullable=True))
    op.add_column('members', sa.Column('dues15_paid_date', sa.DateTime(), nullable=True))
    op.add_column('members', sa.Column('dues15_reduced', sa.Boolean(), nullable=True))
    op.add_column('members', sa.Column('dues15_start', sa.Unicode(length=255), nullable=True))
    op.add_column('members', sa.Column('dues15_token', sa.Unicode(length=10), nullable=True))
