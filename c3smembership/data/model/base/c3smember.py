...
class C3sMember(Base):
    ...
    * Membership Number given upon approval.
    ...
    dues20_invoice = Column(Boolean, default=False)
    dues20_invoice_date = Column(DateTime())
    dues20_invoice_no = Column(Integer())
    dues20_token = Column(Unicode(10))
    dues20_start = Column(Unicode(255))
    dues20_amount = Column(
        DatabaseDecimal(12, 2), default=Decimal('NaN'))
    dues20_reduced = Column(Boolean, default=False)
    _dues20_amount_reduced = Column(
        'dues20_amount_reduced',
        DatabaseDecimal(12, 2), default=Decimal('NaN'))
    # balance
    _dues20_balance = Column(
        'dues20_balance',
        DatabaseDecimal(12, 2), default=Decimal('0'))
    dues20_balanced = Column(Boolean, default=True)
    # payment
    dues20_paid = Column(Boolean, default=False)
    dues20_amount_paid = Column(
        DatabaseDecimal(12, 2), default=Decimal('0'))
    dues20_paid_date = Column(DateTime())

    # membership dues for 2021
    dues21_invoice = Column(Boolean, default=False)
    dues21_invoice_date = Column(DateTime())
    dues21_invoice_no = Column(Integer())
    dues21_token = Column(Unicode(10))
    dues21_start = Column(Unicode(255))
    dues21_amount = Column(
        DatabaseDecimal(12, 2), default=Decimal('NaN'))
    dues21_reduced = Column(Boolean, default=False)
    _dues21_amount_reduced = Column(
        'dues21_amount_reduced',
        DatabaseDecimal(12, 2), default=Decimal('NaN'))
    # balance
    _dues21_balance = Column(
        'dues21_balance',
        DatabaseDecimal(12, 2), default=Decimal('0'))
    dues21_balanced = Column(Boolean, default=True)
    # payment
    dues21_paid = Column(Boolean, default=False)
    dues21_amount_paid = Column(
        DatabaseDecimal(12, 2), default=Decimal('0'))
    dues21_paid_date = Column(DateTime())

    # membership dues for 2022
    dues22_invoice = Column(Boolean, default=False)
    dues22_invoice_date = Column(DateTime())
    dues22_invoice_no = Column(Integer())
    dues22_token = Column(Unicode(10))
    dues22_start = Column(Unicode(255))
    dues22_amount = Column(
        DatabaseDecimal(12, 2), default=Decimal('NaN'))
    dues22_reduced = Column(Boolean, default=False)
    _dues22_amount_reduced = Column(
        'dues22_amount_reduced',
        DatabaseDecimal(12, 2), default=Decimal('NaN'))
    # balance
    _dues22_balance = Column(
        'dues22_balance',
        DatabaseDecimal(12, 2), default=Decimal('0'))
    dues22_balanced = Column(Boolean, default=True)
    # payment
    dues22_paid = Column(Boolean, default=False)
    dues22_amount_paid = Column(
        DatabaseDecimal(12, 2), default=Decimal('0'))
    dues22_paid_date = Column(DateTime())

    # membership dues for 2023
    dues23_invoice = Column(Boolean, default=False)
    dues23_invoice_date = Column(DateTime())
    dues23_invoice_no = Column(Integer())
    dues23_token = Column(Unicode(10))
    dues23_start = Column(Unicode(255))
    dues23_amount = Column(
        DatabaseDecimal(12, 2), default=Decimal('NaN'))
    dues23_reduced = Column(Boolean, default=False)
    _dues23_amount_reduced = Column(
        'dues23_amount_reduced',
        DatabaseDecimal(12, 2), default=Decimal('NaN'))
    # balance
    _dues23_balance = Column(
        'dues23_balance',
        DatabaseDecimal(12, 2), default=Decimal('0'))
    dues23_balanced = Column(Boolean, default=True)
    # payment
    dues23_paid = Column(Boolean, default=False)
    dues23_amount_paid = Column(
        DatabaseDecimal(12, 2), default=Decimal('0'))
    dues23_paid_date = Column(DateTime())

    # membership dues for 2024
    dues24_invoice = Column(Boolean, default=False)
    dues24_invoice_date = Column(DateTime())
    dues24_invoice_no = Column(Integer())
    dues24_token = Column(Unicode(10))
    dues24_start = Column(Unicode(255))
    dues24_amount = Column(
        DatabaseDecimal(12, 2), default=Decimal('NaN'))
    dues24_reduced = Column(Boolean, default=False)
    _dues24_amount_reduced = Column(
        'dues24_amount_reduced',
        DatabaseDecimal(12, 2), default=Decimal('NaN'))
    # balance
    _dues24_balance = Column(
        'dues24_balance',
        DatabaseDecimal(12, 2), default=Decimal('0'))
    dues24_balanced = Column(Boolean, default=True)
    # payment
    dues24_paid = Column(Boolean, default=False)
    dues24_amount_paid = Column(
        DatabaseDecimal(12, 2), default=Decimal('0'))
    ...
    dues26_invoice = Column(Boolean, default=False)
    dues26_invoice_date = Column(DateTime())
    dues26_invoice_no = Column(Integer())
    dues26_token = Column(Unicode(10))
    dues26_start = Column(Unicode(255))
    dues26_amount = Column(
        DatabaseDecimal(12, 2), default=Decimal('NaN'))
    dues26_reduced = Column(Boolean, default=False)
    _dues26_amount_reduced = Column(
        'dues26_amount_reduced',
        DatabaseDecimal(12, 2), default=Decimal('NaN'))
    # balance
    _dues26_balance = Column(
        'dues26_balance',
        DatabaseDecimal(12, 2), default=Decimal('0'))
    dues26_balanced = Column(Boolean, default=True)
    # payment
    dues26_paid = Column(Boolean, default=False)
    dues26_amount_paid = Column(
        DatabaseDecimal(12, 2), default=Decimal('0'))
    dues26_paid_date = Column(DateTime())
    ...
    @hybrid_property
    def dues20_balance(self):
        """
        Get the 2020 dues balance, i.e. amount due subtracted by amount paid.
        """
        return self._dues20_balance

    @dues20_balance.setter
    def dues20_balance(self, dues20_balance):
        """
        Set the 2020 dues balance.

        If balance is set to 0 the balanced flag is set to True.
        """
        self._dues20_balance = dues20_balance
        self.dues20_balanced = self._dues20_balance == Decimal('0')

    @hybrid_property
    def dues20_amount_reduced(self):
        """
        Get the reduced amount for 2020 dues.

        The originally calculated dues amount can be reduced on member's
        request. This gets the amount the dues was reduced to.
        """
        return self._dues20_amount_reduced

    @dues20_amount_reduced.setter
    def dues20_amount_reduced(self, dues20_amount_reduced):
        """
        Set the reduced 2018 dues amount.
        ...
        request. This sets the amount the dues was reduced to.
        """
        self._dues20_amount_reduced = dues20_amount_reduced
        self.dues20_reduced = \
            not math.isnan(self.dues20_amount_reduced) \
            and \
            self.dues20_amount_reduced != self.dues20_amount

    @hybrid_property
    def dues21_balance(self):
        """
        Get the 2021 dues balance, i.e. amount due subtracted by amount paid.
        """
        return self._dues21_balance

    @dues21_balance.setter
    def dues21_balance(self, dues21_balance):
        """
        Set the 2021 dues balance.

        If balance is set to 0 the balanced flag is set to True.
        """
        self._dues21_balance = dues21_balance
        self.dues21_balanced = self._dues21_balance == Decimal('0')

    @hybrid_property
    def dues21_amount_reduced(self):
        """
        Get the reduced amount for 2021 dues.

        The originally calculated dues amount can be reduced on member's
        request. This gets the amount the dues was reduced to.
        """
        return self._dues21_amount_reduced

    @dues21_amount_reduced.setter
    def dues21_amount_reduced(self, dues21_amount_reduced):
        """
        Set the reduced 2018 dues amount.
        ...
        request. This sets the amount the dues was reduced to.
        """
        self._dues21_amount_reduced = dues21_amount_reduced
        self.dues21_reduced = \
            not math.isnan(self.dues21_amount_reduced) \
            and \
            self.dues21_amount_reduced != self.dues21_amount

    @hybrid_property
    def dues22_balance(self):
        """
        Get the 2022 dues balance, i.e. amount due subtracted by amount paid.
        """
        return self._dues22_balance

    @dues22_balance.setter
    def dues22_balance(self, dues22_balance):
        """
        Set the 2022 dues balance.

        If balance is set to 0 the balanced flag is set to True.
        """
        self._dues22_balance = dues22_balance
        self.dues22_balanced = self._dues22_balance == Decimal('0')

    @hybrid_property
    def dues22_amount_reduced(self):
        """
        Get the reduced amount for 2022 dues.

        The originally calculated dues amount can be reduced on member's
        request. This gets the amount the dues was reduced to.
        """
        return self._dues22_amount_reduced

    @dues22_amount_reduced.setter
    def dues22_amount_reduced(self, dues22_amount_reduced):
        """
        Set the reduced 2018 dues amount.
        ...
        request. This sets the amount the dues was reduced to.
        """
        self._dues22_amount_reduced = dues22_amount_reduced
        self.dues22_reduced = \
            not math.isnan(self.dues22_amount_reduced) \
            and \
            self.dues22_amount_reduced != self.dues22_amount

    @hybrid_property
    def dues23_balance(self):
        """
        Get the 2023 dues balance, i.e. amount due subtracted by amount paid.
        """
        return self._dues23_balance

    @dues23_balance.setter
    def dues23_balance(self, dues23_balance):
        """
        Set the 2023 dues balance.

        If balance is set to 0 the balanced flag is set to True.
        """
        self._dues23_balance = dues23_balance
        self.dues23_balanced = self._dues23_balance == Decimal('0')

    @hybrid_property
    def dues23_amount_reduced(self):
        """
        Get the reduced amount for 2023 dues.

        The originally calculated dues amount can be reduced on member's
        request. This gets the amount the dues was reduced to.
        """
        return self._dues23_amount_reduced

    @dues23_amount_reduced.setter
    def dues23_amount_reduced(self, dues23_amount_reduced):
        """
        Set the reduced 2018 dues amount.
        ...
        request. This sets the amount the dues was reduced to.
        """
        self._dues23_amount_reduced = dues23_amount_reduced
        self.dues23_reduced = \
            not math.isnan(self.dues23_amount_reduced) \
            and \
            self.dues23_amount_reduced != self.dues23_amount

    @hybrid_property
    def dues24_balance(self):
        """
        Get the 2024 dues balance, i.e. amount due subtracted by amount paid.
        """
        return self._dues24_balance

    @dues24_balance.setter
    def dues24_balance(self, dues24_balance):
        """
        Set the 2024 dues balance.

        If balance is set to 0 the balanced flag is set to True.
        """
        self._dues24_balance = dues24_balance
        self.dues24_balanced = self._dues24_balance == Decimal('0')

    @hybrid_property
    def dues24_amount_reduced(self):
        """
        Get the reduced amount for 2024 dues.

        The originally calculated dues amount can be reduced on member's
        request. This gets the amount the dues was reduced to.
        """
        return self._dues24_amount_reduced

    @dues24_amount_reduced.setter
    def dues24_amount_reduced(self, dues24_amount_reduced):
        """
        Set the reduced 2018 dues amount.
        ...
        request. This sets the amount the dues was reduced to.
        """
        self._dues24_amount_reduced = dues24_amount_reduced
        self.dues24_reduced = \
            not math.isnan(self.dues24_amount_reduced) \
            and \
    ...
    @hybrid_property
    def dues26_balance(self):
        """
        Get the 2026 dues balance, i.e. amount due subtracted by amount paid.
        """
        return self._dues26_balance

    @dues26_balance.setter
    def dues26_balance(self, dues26_balance):
        """
        Set the 2026 dues balance.

        If balance is set to 0 the balanced flag is set to True.
        """
        self._dues26_balance = dues26_balance
        self.dues26_balanced = self._dues26_balance == Decimal('0')

    @hybrid_property
    def dues26_amount_reduced(self):
        """
        Get the reduced amount for 2026 dues.
        """
        return self._dues26_amount_reduced

    @dues26_amount_reduced.setter
    def dues26_amount_reduced(self, dues26_amount_reduced):
        """
        Set the reduced 2026 dues amount.
        """
        self._dues26_amount_reduced = dues26_amount_reduced
        self.dues26_reduced = \
            not math.isnan(self.dues26_amount_reduced) \
            and \
            self.dues26_amount_reduced != self.dues26_amount
    ...
    @classmethod
    def get_dues20_invoicees(cls, num):
        """
        Get a given number *n* of members to send dues invoices to.
    ...
    @classmethod
    def get_dues21_invoicees(cls, num):
        """
        Get a given number *n* of members to send dues invoices to.
    ...
    @classmethod
    def get_dues22_invoicees(cls, num):
        """
        Get a given number *n* of members to send dues invoices to.
    ...
    @classmethod
    def get_dues23_invoicees(cls, num):
        """
        Get a given number *n* of members to send dues invoices to.
    ...
    @classmethod
    def get_dues24_invoicees(cls, num):
        """
        Get a given number *n* of members to send dues invoices to.
    ...
    @classmethod
    def get_dues26_invoicees(cls, num):
        """
        Get a given number *n* of members to send dues invoices to.
    ...
    def set_dues20_payment(self, paid_amount, paid_date):
        if math.isnan(self.dues20_amount_paid):
            dues20_amount_paid = Decimal('0')
        else:
            dues20_amount_paid = self.dues20_amount_paid

        self.dues20_paid = True
        self.dues20_amount_paid = dues20_amount_paid + paid_amount
        self.dues20_paid_date = paid_date
        self.dues20_balance = self.dues20_balance - paid_amount

    def set_dues20_amount(self, dues_amount):
        if math.isnan(self.dues20_amount) \
                or not isinstance(self.dues20_amount, Decimal):
            dues20_amount = Decimal('0')
        else:
            dues20_amount = self.dues20_amount

        self.dues20_balance = self.dues20_balance - dues20_amount + Decimal(
            dues_amount)  # what they actually have to pay
        self.dues20_amount = dues_amount  # what they have to pay (calc'ed)

    def set_dues20_reduced_amount(self, reduced_amount):
        if reduced_amount != self.dues20_amount:
            previous_amount_in_balance = (
                self.dues20_amount_reduced
                if self.dues20_reduced
                else self.dues20_amount)
            self.dues20_balance = self.dues20_balance - \
                previous_amount_in_balance + reduced_amount
            self.dues20_amount_reduced = reduced_amount
        else:
            self.dues20_amount_reduced = Decimal('NaN')

    def set_dues21_payment(self, paid_amount, paid_date):
        if math.isnan(self.dues21_amount_paid):
            dues21_amount_paid = Decimal('0')
        else:
            dues21_amount_paid = self.dues21_amount_paid

        self.dues21_paid = True
        self.dues21_amount_paid = dues21_amount_paid + paid_amount
        self.dues21_paid_date = paid_date
        self.dues21_balance = self.dues21_balance - paid_amount

    def set_dues21_amount(self, dues_amount):
        if math.isnan(self.dues21_amount) \
                or not isinstance(self.dues21_amount, Decimal):
            dues21_amount = Decimal('0')
        else:
            dues21_amount = self.dues21_amount

        self.dues21_balance = self.dues21_balance - dues21_amount + Decimal(
            dues_amount)  # what they actually have to pay
        self.dues21_amount = dues_amount  # what they have to pay (calc'ed)

    def set_dues21_reduced_amount(self, reduced_amount):
        if reduced_amount != self.dues21_amount:
            previous_amount_in_balance = (
                self.dues21_amount_reduced
                if self.dues21_reduced
                else self.dues21_amount)
            self.dues21_balance = self.dues21_balance - \
                previous_amount_in_balance + reduced_amount
            self.dues21_amount_reduced = reduced_amount
        else:
            self.dues21_amount_reduced = Decimal('NaN')

    def set_dues22_payment(self, paid_amount, paid_date):
        if math.isnan(self.dues22_amount_paid):
            dues22_amount_paid = Decimal('0')
        else:
            dues22_amount_paid = self.dues22_amount_paid

        self.dues22_paid = True
        self.dues22_amount_paid = dues22_amount_paid + paid_amount
        self.dues22_paid_date = paid_date
        self.dues22_balance = self.dues22_balance - paid_amount

    def set_dues22_amount(self, dues_amount):
        if math.isnan(self.dues22_amount) \
                or not isinstance(self.dues22_amount, Decimal):
            dues22_amount = Decimal('0')
        else:
            dues22_amount = self.dues22_amount

        self.dues22_balance = self.dues22_balance - dues22_amount + Decimal(
            dues_amount)  # what they actually have to pay
        self.dues22_amount = dues_amount  # what they have to pay (calc'ed)

    def set_dues22_reduced_amount(self, reduced_amount):
        if reduced_amount != self.dues22_amount:
            previous_amount_in_balance = (
                self.dues22_amount_reduced
                if self.dues22_reduced
                else self.dues22_amount)
            self.dues22_balance = self.dues22_balance - \
                previous_amount_in_balance + reduced_amount
            self.dues22_amount_reduced = reduced_amount
        else:
            self.dues22_amount_reduced = Decimal('NaN')

    def set_dues23_payment(self, paid_amount, paid_date):
        if math.isnan(self.dues23_amount_paid):
            dues23_amount_paid = Decimal('0')
        else:
            dues23_amount_paid = self.dues23_amount_paid

        self.dues23_paid = True
        self.dues23_amount_paid = dues23_amount_paid + paid_amount
        self.dues23_paid_date = paid_date
        self.dues23_balance = self.dues23_balance - paid_amount

    def set_dues23_amount(self, dues_amount):
        if math.isnan(self.dues23_amount) \
                or not isinstance(self.dues23_amount, Decimal):
            dues23_amount = Decimal('0')
        else:
            dues23_amount = self.dues23_amount

        self.dues23_balance = self.dues23_balance - dues23_amount + Decimal(
            dues_amount)  # what they actually have to pay
        self.dues23_amount = dues_amount  # what they have to pay (calc'ed)

    def set_dues23_reduced_amount(self, reduced_amount):
        if reduced_amount != self.dues23_amount:
            previous_amount_in_balance = (
                self.dues23_amount_reduced
                if self.dues23_reduced
                else self.dues23_amount)
            self.dues23_balance = self.dues23_balance - \
                previous_amount_in_balance + reduced_amount
            self.dues23_amount_reduced = reduced_amount
        else:
            self.dues23_amount_reduced = Decimal('NaN')

    def set_dues24_payment(self, paid_amount, paid_date):
        if math.isnan(self.dues24_amount_paid):
            dues24_amount_paid = Decimal('0')
        else:
            dues24_amount_paid = self.dues24_amount_paid

        self.dues24_paid = True
        self.dues24_amount_paid = dues24_amount_paid + paid_amount
        self.dues24_paid_date = paid_date
        self.dues24_balance = self.dues24_balance - paid_amount

    def set_dues24_amount(self, dues_amount):
        if math.isnan(self.dues24_amount) \
                or not isinstance(self.dues24_amount, Decimal):
            dues24_amount = Decimal('0')
        else:
            dues24_amount = self.dues24_amount

        self.dues24_balance = self.dues24_balance - dues24_amount + Decimal(
            dues_amount)  # what they actually have to pay
        self.dues24_amount = dues_amount  # what they have to pay (calc'ed)

    def set_dues24_reduced_amount(self, reduced_amount):
        if reduced_amount != self.dues24_amount:
            previous_amount_in_balance = (
                self.dues24_amount_reduced
                if self.dues24_reduced
                else self.dues24_amount)
            self.dues24_balance = self.dues24_balance - \
                previous_amount_in_balance + reduced_amount
    ...
    def set_dues26_payment(self, paid_amount, paid_date):
        if math.isnan(self.dues26_amount_paid):
            dues26_amount_paid = Decimal('0')
        else:
            dues26_amount_paid = self.dues26_amount_paid

        self.dues26_paid = True
        self.dues26_amount_paid = dues26_amount_paid + paid_amount
        self.dues26_paid_date = paid_date
        self.dues26_balance = self.dues26_balance - paid_amount

    def set_dues26_amount(self, dues_amount):
        if math.isnan(self.dues26_amount) \
                or not isinstance(self.dues26_amount, Decimal):
            dues26_amount = Decimal('0')
        else:
            dues26_amount = self.dues26_amount

        self.dues26_balance = self.dues26_balance - dues26_amount + Decimal(
            dues_amount)
        self.dues26_amount = dues_amount

    def set_dues26_reduced_amount(self, reduced_amount):
        if reduced_amount != self.dues26_amount:
            previous_amount_in_balance = (
                self.dues26_amount_reduced
                if self.dues26_reduced
                else self.dues26_amount)
            self.dues26_balance = self.dues26_balance - \
                previous_amount_in_balance + reduced_amount
            self.dues26_amount_reduced = reduced_amount
        else:
            self.dues26_amount_reduced = Decimal('NaN')
