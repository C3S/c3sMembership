...
def main(argv=sys.argv):
    ...
    with transaction.manager:
        member1 = C3sMember(
            ...
            country="Foocountry",
            locale="en",
            date_of_birth=date(1971, 0o2, 0o3),
    ...
    with transaction.manager:
        ...
        legal_entity_de = C3sMember(  # german investing legal entity
            firstname='Günther Vorstand',
            lastname='Deutscher Musikverlag',
            email='uat.yes@example.com',
            address1="Ährenweg 1",
            address2="",
            postcode="98765",
        ...
        legal_entity_en = C3sMember(  # english investing legal entity
            firstname='John BigBoss',
            lastname='Some Company',
            email='uat.yes@example.com',
