...
class QuarterlyDuesCalculator(object):
    ...
    _QUARTERLY_DESCRIPTIONS = {
        'en': {
            'q1': 'whole year {year}',
            'q2': 'from second quarter {year}',
            'q3': 'from third quarter {year}',
            'q4': 'from fourth quarter {year}',
        },
        'de': {
            'q1': 'für das ganze Jahr {year}',
            'q2': 'ab zweitem Quartal {year}',
            'q3': 'ab drittem Quartal {year}',
            'q4': 'ab viertem Quartal {year}',
        },
    }
    ...
    def calculate(self, member):
        ...
        if member.membership_type == 'normal':
            ...
            if quarter is not None:
                ...
                code = '{quarter}_{year}'.format(quarter=quarter,
                                                  year=self._year)
