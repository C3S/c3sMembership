...
class C3sMembershipModelTests(C3sMembershipModelTestBase):
    ...
    def test_get_dues17_invoicees(self):
        ...
        invoicees = my_membership_signee_class.get_dues17_invoicees(27)
        self.assertEqual(len(invoicees), 2)
    ...
    def test_get_dues22_invoicees(self):
        """
        test: get all members that haven't had their invoices sent
        """
        year = 2022
        ...
        instance2.membership_accepted = False
        instance2.membership_date = None
        invoicees = my_membership_signee_class.get_dues22_invoicees(27)
        self.assertEqual(len(invoicees), 0)
    ...
    def test_get_dues23_invoicees(self):
        """
        test: get all members that haven't had their invoices sent
        """
        year = 2023
        ...
        instance2.membership_accepted = False
        instance2.membership_date = None
        invoicees = my_membership_signee_class.get_dues23_invoicees(27)
        self.assertEqual(len(invoicees), 0)
    ...
    def test_get_dues24_invoicees(self):
        """
        test: get all members that haven't had their invoices sent
        """
        year = 2024
        ...
        instance2.membership_accepted = False
        instance2.membership_date = None
        invoicees = my_membership_signee_class.get_dues24_invoicees(27)
        self.assertEqual(len(invoicees), 0)
    ...
    def test_get_dues25_invoicees(self):
        """
        test: get all members that haven't had their invoices sent
        """
        year = 2025
        ...
        instance2.membership_accepted = False
        instance2.membership_date = None
        invoicees = my_membership_signee_class.get_dues25_invoicees(27)
        self.assertEqual(len(invoicees), 0)
    ...
    def test_get_dues26_invoicees(self):
        """
        test: get all members that haven't had their invoices sent
        """
        year = 2026
        ...
        instance2.membership_accepted = False
        instance2.membership_date = None
        invoicees = my_membership_signee_class.get_dues26_invoicees(27)
        self.assertEqual(len(invoicees), 0)
...
class Dues15InvoiceModelTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with transaction.manager:
            ...
            dues2 = Dues15Invoice(
                invoice_no=2,
                invoice_no_string='C3S-dues15-0002-S',
                invoice_date=date(2015, 10, 0o2),
            ...
            dues3 = Dues15Invoice(
                invoice_no=3,
                invoice_no_string='C3S-dues15-0003',
            ...
            dues4 = Dues15Invoice(
                invoice_no=4,
                invoice_no_string='C3S-dues15-0004-S',
            ...
            dues5 = Dues15Invoice(
                invoice_no=5,
                invoice_no_string='C3S-dues15-0005',
            ...
            dues6 = Dues15Invoice(
                invoice_no=6,
                invoice_no_string='C3S-dues15-0006-S',
    ...
    def test_decimality(self):
        ...
        def trigger_integrity_error_1():
            dues2 = Dues15Invoice(
                ...
                invoice_amount=str(D('-37.50').to_eng_string()),
                member_id=1,
                membership_no=1,
                email='test@example.com',
                token='ABCDEFGH',
        ...
        def trigger_invalid_operation():
            dues2 = Dues15Invoice(
                invoice_no=5,
                invoice_no_string='C3S-dues15-0002',
                invoice_date=date.today(),
                invoice_amount=str(D('-37.50.20').to_eng_string()),
                member_id=1,
                membership_no=1,
                email='test@example.com',
                token='ABCDEFGH',
...
class Dues16InvoiceModelTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with transaction.manager:
            ...
            dues1 = Dues16Invoice(
                invoice_no=1,
                invoice_no_string='C3S-dues16-0001',
                invoice_date=date(2015, 10, 0o1),
                invoice_amount=D('-37.50'),
                member_id=1,
                membership_no=1,
            ...
            dues2 = Dues16Invoice(
                invoice_no=2,
                invoice_no_string='C3S-dues16-0002-S',
                invoice_date=date(2015, 10, 0o2),
                invoice_amount=D('17.25'),
                member_id=1,
                membership_no=1,
            ...
            dues3 = Dues16Invoice(
                invoice_no=3,
                invoice_no_string='C3S-dues16-0003',
                invoice_date=date(2015, 11, 25),
                invoice_amount=D('74.58'),
                member_id=1,
                membership_no=2,
            ...
            dues4 = Dues16Invoice(
                invoice_no=4,
                invoice_no_string='C3S-dues16-0004-S',
                invoice_date=date(2015, 11, 27),
                invoice_amount=D('23.85'),
                member_id=1,
                membership_no=2,
            ...
            dues5 = Dues16Invoice(
                invoice_no=5,
                invoice_no_string='C3S-dues16-0005',
                invoice_date=date(2015, 11, 29),
                invoice_amount=D('12.89'),
                member_id=1,
                membership_no=3,
            ...
            dues6 = Dues16Invoice(
                invoice_no=6,
                invoice_no_string='C3S-dues16-0006-S',
                invoice_date=date(2015, 11, 30),
                invoice_amount=D('77.79'),
                member_id=1,
                membership_no=3,
...
class Dues17InvoiceModelTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with transaction.manager:
            ...
            dues1 = Dues17Invoice(
                invoice_no=1,
                invoice_no_string='C3S-dues17-0001',
                invoice_date=date(2015, 10, 0o1),
                invoice_amount=D('-37.50'),
                member_id=1,
                membership_no=1,
            ...
            dues2 = Dues17Invoice(
                invoice_no=2,
                invoice_no_string='C3S-dues17-0002-S',
                invoice_date=date(2015, 10, 0o2),
            ...
            dues3 = Dues17Invoice(
                invoice_no=3,
                invoice_no_string='C3S-dues17-0003',
                invoice_date=date(2015, 11, 25),
                invoice_amount=D('74.58'),
                member_id=1,
                membership_no=2,
            ...
            dues4 = Dues17Invoice(
                invoice_no=4,
                invoice_no_string='C3S-dues17-0004-S',
                invoice_date=date(2015, 11, 27),
                invoice_amount=D('23.85'),
                member_id=1,
                membership_no=2,
            ...
            dues5 = Dues17Invoice(
                invoice_no=5,
                invoice_no_string='C3S-dues17-0005',
                invoice_date=date(2015, 11, 29),
                invoice_amount=D('12.89'),
                member_id=1,
                membership_no=3,
            ...
            dues6 = Dues17Invoice(
                invoice_no=6,
                invoice_no_string='C3S-dues17-0006-S',
                invoice_date=date(2015, 11, 30),
                invoice_amount=D('77.79'),
                member_id=1,
                membership_no=3,
    ...
    def test_decimality(self):
        ...
        def trigger_invalid_operation():
            dues2 = Dues17Invoice(
                invoice_no=5,
                invoice_no_string='C3S-dues17-0002',
                invoice_date=date.today(),
                invoice_amount=str(D('-37.50.20').to_eng_string()),
                member_id=1,
                membership_no=1,
...
class Dues18InvoiceModelTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with transaction.manager:
            ...
            dues1 = Dues18Invoice(
                invoice_no=1,
                invoice_no_string='C3S-dues18-0001',
                invoice_date=date(2015, 10, 0o1),
                invoice_amount=D('-37.50'),
                member_id=1,
                membership_no=1,
            ...
            dues2 = Dues18Invoice(
                invoice_no=2,
                invoice_no_string='C3S-dues18-0002-S',
                invoice_date=date(2015, 10, 0o2),
                invoice_amount=D('16.25'),
                member_id=1,
                membership_no=1,
            ...
            dues3 = Dues18Invoice(
                invoice_no=3,
                invoice_no_string='C3S-dues18-0003',
                invoice_date=date(2015, 11, 25),
                invoice_amount=D('74.58'),
                member_id=1,
                membership_no=2,
            ...
            dues4 = Dues18Invoice(
                invoice_no=4,
                invoice_no_string='C3S-dues18-0004-S',
                invoice_date=date(2015, 11, 27),
                invoice_amount=D('23.85'),
                member_id=1,
                membership_no=2,
            ...
            dues5 = Dues18Invoice(
                invoice_no=5,
                invoice_no_string='C3S-dues18-0005',
                invoice_date=date(2015, 11, 29),
                invoice_amount=D('12.89'),
                member_id=1,
                membership_no=3,
            ...
            dues6 = Dues18Invoice(
                invoice_no=6,
                invoice_no_string='C3S-dues18-0006-S',
                invoice_date=date(2015, 11, 30),
                invoice_amount=D('77.79'),
                member_id=1,
                membership_no=3,
    ...
    def test_decimality(self):
        ...
        def trigger_invalid_operation():
            dues2 = Dues18Invoice(
                invoice_no=5,
                invoice_no_string='C3S-dues18-0002',
                invoice_date=date.today(),
                invoice_amount=str(D('-37.50.20').to_eng_string()),
                member_id=1,
                membership_no=1,
...
class Dues19InvoiceModelTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with transaction.manager:
            ...
            dues1 = Dues19Invoice(
                invoice_no=1,
                invoice_no_string='C3S-dues19-0001',
                invoice_date=date(2015, 10, 0o1),
                invoice_amount=D('-37.50'),
                member_id=1,
                membership_no=1,
            ...
            dues2 = Dues19Invoice(
                invoice_no=2,
                invoice_no_string='C3S-dues19-0002-S',
                invoice_date=date(2015, 10, 0o2),
                invoice_amount=D('16.25'),
                member_id=1,
                membership_no=1,
            ...
            dues3 = Dues19Invoice(
                invoice_no=3,
                invoice_no_string='C3S-dues19-0003',
                invoice_date=date(2015, 11, 25),
                invoice_amount=D('74.58'),
                member_id=1,
                membership_no=2,
            ...
            dues4 = Dues19Invoice(
                invoice_no=4,
                invoice_no_string='C3S-dues19-0004-S',
                invoice_date=date(2015, 11, 27),
                invoice_amount=D('23.85'),
                member_id=1,
                membership_no=2,
            ...
            dues5 = Dues19Invoice(
                invoice_no=5,
                invoice_no_string='C3S-dues19-0005',
                invoice_date=date(2015, 11, 29),
                invoice_amount=D('12.89'),
                member_id=1,
                membership_no=3,
            ...
            dues6 = Dues19Invoice(
                invoice_no=6,
                invoice_no_string='C3S-dues19-0006-S',
                invoice_date=date(2015, 11, 30),
                invoice_amount=D('77.79'),
                member_id=1,
                membership_no=3,
    ...
    def test_decimality(self):
        ...
        def trigger_invalid_operation():
            dues2 = Dues19Invoice(
                invoice_no=5,
                invoice_no_string='C3S-dues19-0002',
                invoice_date=date.today(),
                invoice_amount=str(D('-37.50.20').to_eng_string()),
                member_id=1,
                membership_no=1,
...
class Dues20InvoiceModelTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with transaction.manager:
            ...
            dues1 = Dues20Invoice(
                invoice_no=1,
                invoice_no_string='C3S-dues20-0001',
                invoice_date=date(2015, 10, 0o1),
                invoice_amount=D('-37.50'),
                member_id=1,
                membership_no=1,
            ...
            dues2 = Dues20Invoice(
                invoice_no=2,
                invoice_no_string='C3S-dues20-0002-S',
                invoice_date=date(2015, 10, 0o2),
                invoice_amount=D('16.25'),
                member_id=1,
                membership_no=1,
            ...
            dues3 = Dues20Invoice(
                invoice_no=3,
                invoice_no_string='C3S-dues20-0003',
                invoice_date=date(2015, 11, 25),
                invoice_amount=D('74.58'),
                member_id=1,
                membership_no=2,
            ...
            dues4 = Dues20Invoice(
                invoice_no=4,
                invoice_no_string='C3S-dues20-0004-S',
                invoice_date=date(2015, 11, 27),
                invoice_amount=D('23.85'),
                member_id=1,
                membership_no=2,
            ...
            dues5 = Dues20Invoice(
                invoice_no=5,
                invoice_no_string='C3S-dues20-0005',
                invoice_date=date(2015, 11, 29),
                invoice_amount=D('12.89'),
                member_id=1,
                membership_no=3,
            ...
            dues6 = Dues20Invoice(
                invoice_no=6,
                invoice_no_string='C3S-dues20-0006-S',
                invoice_date=date(2015, 11, 30),
                invoice_amount=D('77.79'),
                member_id=1,
                membership_no=3,
    ...
    def test_decimality(self):
        ...
        def trigger_invalid_operation():
            dues2 = Dues20Invoice(
                invoice_no=5,
                invoice_no_string='C3S-dues20-0002',
                invoice_date=date.today(),
                invoice_amount=str(D('-37.50.20').to_eng_string()),
                member_id=1,
                membership_no=1,
...
class Dues21InvoiceModelTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with transaction.manager:
            ...
            dues1 = Dues21Invoice(
                invoice_no=1,
                invoice_no_string='C3S-dues21-0001',
                invoice_date=date(2015, 10, 0o1),
                invoice_amount=D('-37.50'),
                member_id=1,
                membership_no=1,
            ...
            dues2 = Dues21Invoice(
                invoice_no=2,
                invoice_no_string='C3S-dues21-0002-S',
                invoice_date=date(2015, 10, 0o2),
                invoice_amount=D('16.25'),
                member_id=1,
                membership_no=1,
            ...
            dues3 = Dues21Invoice(
                invoice_no=3,
                invoice_no_string='C3S-dues21-0003',
                invoice_date=date(2015, 11, 25),
                invoice_amount=D('74.58'),
                member_id=1,
                membership_no=2,
            ...
            dues4 = Dues21Invoice(
                invoice_no=4,
                invoice_no_string='C3S-dues21-0004-S',
                invoice_date=date(2015, 11, 27),
                invoice_amount=D('23.85'),
                member_id=1,
                membership_no=2,
            ...
            dues5 = Dues21Invoice(
                invoice_no=5,
                invoice_no_string='C3S-dues21-0005',
                invoice_date=date(2015, 11, 29),
                invoice_amount=D('12.89'),
                member_id=1,
                membership_no=3,
            ...
            dues6 = Dues21Invoice(
                invoice_no=6,
                invoice_no_string='C3S-dues21-0006-S',
                invoice_date=date(2015, 11, 30),
                invoice_amount=D('77.79'),
                member_id=1,
                membership_no=3,
    ...
    def test_decimality(self):
        ...
        def trigger_invalid_operation():
            dues2 = Dues21Invoice(
                invoice_no=5,
                invoice_no_string='C3S-dues21-0002',
                invoice_date=date.today(),
                invoice_amount=str(D('-37.50.20').to_eng_string()),
                member_id=1,
                membership_no=1,
...
class Dues22InvoiceModelTests(unittest.TestCase):
    """
    test the dues22 invoice model
    """
    def setUp(self):
        self.config = testing.setUp()
        self.config.include('pyramid_mailer.testing')
        ...
        with transaction.manager:
            ...
            dues1 = Dues22Invoice(
                invoice_no=1,
                invoice_no_string='C3S-dues22-0001',
                invoice_date=date(2015, 10, 0o1),
                invoice_amount=D('-37.50'),
                member_id=1,
                membership_no=1,
            ...
            dues2 = Dues22Invoice(
                invoice_no=2,
                invoice_no_string='C3S-dues22-0002-S',
                invoice_date=date(2015, 10, 0o2),
                invoice_amount=D('16.25'),
                member_id=1,
                membership_no=1,
            ...
            dues3 = Dues22Invoice(
                invoice_no=3,
                invoice_no_string='C3S-dues22-0003',
                invoice_date=date(2015, 11, 25),
                invoice_amount=D('74.58'),
                member_id=1,
                membership_no=2,
            ...
            dues4 = Dues22Invoice(
                invoice_no=4,
                invoice_no_string='C3S-dues22-0004-S',
                invoice_date=date(2015, 11, 27),
                invoice_amount=D('23.85'),
                member_id=1,
                membership_no=2,
            ...
            dues5 = Dues22Invoice(
                invoice_no=5,
                invoice_no_string='C3S-dues22-0005',
                invoice_date=date(2015, 11, 29),
                invoice_amount=D('12.89'),
                member_id=1,
                membership_no=3,
            ...
            dues6 = Dues22Invoice(
                invoice_no=6,
                invoice_no_string='C3S-dues22-0006-S',
                invoice_date=date(2015, 11, 30),
                invoice_amount=D('77.79'),
                member_id=1,
                membership_no=3,
            ...
            member1.set_dues22_payment(D('12.34'), date(2015, 10, 31))
            member2.set_dues22_payment(D('95.65'), date(2015, 11, 5))
            member3.set_dues22_payment(D('-85.12'), date(2015, 11, 30))
    ...
    def test_get_all(self):
        ...
        test get_all
        '''
        res = DuesInvoiceRepository.get_all([2022])
        self.assertEqual(len(res), 6)
    ...
    def test_get_by_invoice_no(self):
        ...
        test get_by_invoice_no
        '''
        res = DuesInvoiceRepository.get_by_number(1, 2022)
        self.assertEqual(res.id, 1)
    ...
    def test_get_monthly_stats(self):
        ...
        Test get_monthly_stats.
        """
        stats = DuesInvoiceRepository.get_monthly_stats(2022)
        self.assertEqual(len(stats), 2)
        self.assertEqual(stats[0]['month'], datetime(2015, 10, 1))
        self.assertAlmostEqual(stats[0]['amount_invoiced_normal'], D('-37.50'))
        self.assertAlmostEqual(
    ...
    def test_decimality(self):
        ...
        def trigger_invalid_operation():
            dues2 = Dues22Invoice(
                invoice_no=5,
                invoice_no_string='C3S-dues22-0002',
                invoice_date=date.today(),
                invoice_amount=str(D('-37.50.20').to_eng_string()),
                member_id=1,
                membership_no=1,
        ...
        # now really store a new Dues22Invoice
        dues3 = Dues22Invoice(
            invoice_no=7,
            invoice_no_string='C3S-dues22-0002',
            invoice_date=date.today(),
...
class Dues23InvoiceModelTests(unittest.TestCase):
    """
    test the dues23 invoice model
    """
    def setUp(self):
        self.config = testing.setUp()
        self.config.include('pyramid_mailer.testing')
        ...
        with transaction.manager:
            ...
            dues1 = Dues23Invoice(
                invoice_no=1,
                invoice_no_string='C3S-dues23-0001',
                invoice_date=date(2015, 10, 0o1),
                invoice_amount=D('-37.50'),
                member_id=1,
                membership_no=1,
            ...
            dues2 = Dues23Invoice(
                invoice_no=2,
                invoice_no_string='C3S-dues23-0002-S',
                invoice_date=date(2015, 10, 0o2),
                invoice_amount=D('16.25'),
                member_id=1,
                membership_no=1,
            ...
            dues3 = Dues23Invoice(
                invoice_no=3,
                invoice_no_string='C3S-dues23-0003',
                invoice_date=date(2015, 11, 25),
                invoice_amount=D('74.58'),
                member_id=1,
                membership_no=2,
            ...
            dues4 = Dues23Invoice(
                invoice_no=4,
                invoice_no_string='C3S-dues23-0004-S',
                invoice_date=date(2015, 11, 27),
                invoice_amount=D('23.85'),
                member_id=1,
                membership_no=2,
            ...
            dues5 = Dues23Invoice(
                invoice_no=5,
                invoice_no_string='C3S-dues23-0005',
                invoice_date=date(2015, 11, 29),
                invoice_amount=D('12.89'),
                member_id=1,
                membership_no=3,
            ...
            dues6 = Dues23Invoice(
                invoice_no=6,
                invoice_no_string='C3S-dues23-0006-S',
                invoice_date=date(2015, 11, 30),
                invoice_amount=D('77.79'),
                member_id=1,
                membership_no=3,
            ...
            member1.set_dues23_payment(D('12.34'), date(2015, 10, 31))
            member2.set_dues23_payment(D('95.65'), date(2015, 11, 5))
            member3.set_dues23_payment(D('-85.12'), date(2015, 11, 30))
    ...
    def test_get_all(self):
        ...
        test get_all
        '''
        res = DuesInvoiceRepository.get_all([2023])
        self.assertEqual(len(res), 6)
    ...
    def test_get_by_invoice_no(self):
        ...
        test get_by_invoice_no
        '''
        res = DuesInvoiceRepository.get_by_number(1, 2023)
        self.assertEqual(res.id, 1)
    ...
    def test_get_monthly_stats(self):
        ...
        Test get_monthly_stats.
        """
        stats = DuesInvoiceRepository.get_monthly_stats(2023)
        self.assertEqual(len(stats), 2)
        self.assertEqual(stats[0]['month'], datetime(2015, 10, 1))
        self.assertAlmostEqual(stats[0]['amount_invoiced_normal'], D('-37.50'))
        self.assertAlmostEqual(
    ...
    def test_decimality(self):
        ...
        def trigger_invalid_operation():
            dues2 = Dues23Invoice(
                invoice_no=5,
                invoice_no_string='C3S-dues23-0002',
                invoice_date=date.today(),
                invoice_amount=str(D('-37.50.20').to_eng_string()),
                member_id=1,
                membership_no=1,
        ...
        # now really store a new Dues23Invoice
        dues3 = Dues23Invoice(
            invoice_no=7,
            invoice_no_string='C3S-dues23-0002',
            invoice_date=date.today(),
...
class Dues24InvoiceModelTests(unittest.TestCase):
    """
    test the dues24 invoice model
    """
    def setUp(self):
        self.config = testing.setUp()
        self.config.include('pyramid_mailer.testing')
        ...
        with transaction.manager:
            ...
            dues1 = Dues24Invoice(
                invoice_no=1,
                invoice_no_string='C3S-dues24-0001',
                invoice_date=date(2015, 10, 0o1),
                invoice_amount=D('-37.50'),
                member_id=1,
                membership_no=1,
            ...
            dues2 = Dues24Invoice(
                invoice_no=2,
                invoice_no_string='C3S-dues24-0002-S',
                invoice_date=date(2015, 10, 0o2),
                invoice_amount=D('16.25'),
                member_id=1,
                membership_no=1,
            ...
            dues3 = Dues24Invoice(
                invoice_no=3,
                invoice_no_string='C3S-dues24-0003',
                invoice_date=date(2015, 11, 25),
                invoice_amount=D('74.58'),
                member_id=1,
                membership_no=2,
            ...
            dues4 = Dues24Invoice(
                invoice_no=4,
                invoice_no_string='C3S-dues24-0004-S',
                invoice_date=date(2015, 11, 27),
                invoice_amount=D('24.85'),
                member_id=1,
                membership_no=2,
                email='test@example.com',
                token='f348h98sdf',
            ...
            dues5 = Dues24Invoice(
                invoice_no=5,
                invoice_no_string='C3S-dues24-0005',
                invoice_date=date(2015, 11, 29),
                invoice_amount=D('12.89'),
                member_id=1,
                membership_no=3,
            ...
            dues6 = Dues24Invoice(
                invoice_no=6,
                invoice_no_string='C3S-dues24-0006-S',
                invoice_date=date(2015, 11, 30),
                invoice_amount=D('77.79'),
                member_id=1,
                membership_no=3,
            ...
            member1.set_dues24_payment(D('12.34'), date(2015, 10, 31))
            member2.set_dues24_payment(D('95.65'), date(2015, 11, 5))
            member3.set_dues24_payment(D('-85.12'), date(2015, 11, 30))

class Dues25InvoiceModelTests(unittest.TestCase):
    """
    test the dues25 invoice model
    """
    def setUp(self):
        self.config = testing.setUp()
        self.config.include('pyramid_mailer.testing')
        ...
        with transaction.manager:
            ...
            dues1 = Dues25Invoice(
                invoice_no=1,
                invoice_no_string='C3S-dues25-0001',
                invoice_date=date(2015, 10, 0o1),
                invoice_amount=D('-37.50'),
                member_id=1,
                membership_no=1,
            ...
            dues2 = Dues25Invoice(
                invoice_no=2,
                invoice_no_string='C3S-dues25-0002-S',
                invoice_date=date(2015, 10, 0o2),
                invoice_amount=D('16.25'),
                member_id=1,
                membership_no=1,
            ...
            dues3 = Dues25Invoice(
                invoice_no=3,
                invoice_no_string='C3S-dues25-0003',
                invoice_date=date(2015, 11, 25),
                invoice_amount=D('74.58'),
                member_id=1,
                membership_no=2,
            ...
            dues4 = Dues25Invoice(
                invoice_no=4,
                invoice_no_string='C3S-dues25-0004-S',
                invoice_date=date(2015, 11, 27),
                invoice_amount=D('24.85'),
                member_id=1,
                membership_no=2,
            ...
            dues5 = Dues25Invoice(
                invoice_no=5,
                invoice_no_string='C3S-dues25-0005',
                invoice_date=date(2015, 11, 29),
                invoice_amount=D('12.89'),
                member_id=1,
                membership_no=3,
            ...
            dues6 = Dues25Invoice(
                invoice_no=6,
                invoice_no_string='C3S-dues25-0006-S',
                invoice_date=date(2015, 11, 30),
                invoice_amount=D('77.79'),
                member_id=1,
                membership_no=3,
            ...
            member1.set_dues25_payment(D('12.34'), date(2015, 10, 31))
            member2.set_dues25_payment(D('95.65'), date(2015, 11, 5))
            member3.set_dues25_payment(D('-85.12'), date(2015, 11, 30))
    ...
    def test_get_all(self):
        ...
        test get_all
        '''
        res = DuesInvoiceRepository.get_all([2025])
        self.assertEqual(len(res), 6)
    ...
    def test_get_by_invoice_no(self):
        ...
        test get_by_invoice_no
        '''
        res = DuesInvoiceRepository.get_by_number(1, 2025)
        self.assertEqual(res.id, 1)
    ...
    def test_get_monthly_stats(self):
        ...
        Test get_monthly_stats.
        """
        stats = DuesInvoiceRepository.get_monthly_stats(2025)
        self.assertEqual(len(stats), 2)
        self.assertEqual(stats[0]['month'], datetime(2015, 10, 1))
        self.assertAlmostEqual(stats[0]['amount_invoiced_normal'], D('-37.50'))
        self.assertAlmostEqual(
        ...
        self.assertAlmostEqual(stats[1]['amount_invoiced_normal'], D('87.47'))
        self.assertAlmostEqual(
            stats[1]['amount_invoiced_reversal'], D('102.64'))
        self.assertAlmostEqual(stats[1]['amount_paid'], D('10.53'))
    ...
    def test_decimality(self):
        ...
        def trigger_invalid_operation():
            dues2 = Dues25Invoice(
                invoice_no=5,
                invoice_no_string='C3S-dues25-0002',
                invoice_date=date.today(),
                invoice_amount=str(D('-37.50.20').to_eng_string()),
                member_id=1,
                membership_no=1,
        ...
        # now really store a new Dues25Invoice
        dues3 = Dues25Invoice(
            invoice_no=7,
            invoice_no_string='C3S-dues25-0002',
            invoice_date=date.today(),
...
class Dues26InvoiceModelTests(unittest.TestCase):
    """
    test the dues26 invoice model
    """
    def setUp(self):
        self.config = testing.setUp()
        self.config.include('pyramid_mailer.testing')
        ...
        with transaction.manager:
            ...
            dues1 = Dues26Invoice(
                invoice_no=1,
                invoice_no_string='C3S-dues26-0001',
                invoice_date=date(2015, 10, 0o1),
                invoice_amount=D('-37.50'),
                member_id=1,
                membership_no=1,
            ...
            dues2 = Dues26Invoice(
                invoice_no=2,
                invoice_no_string='C3S-dues26-0002-S',
                invoice_date=date(2015, 10, 0o2),
                invoice_amount=D('16.26'),
                member_id=1,
                membership_no=1,
                email='test@example.com',
                token='fa4wfjlasjfd',
            ...
            dues3 = Dues26Invoice(
                invoice_no=3,
                invoice_no_string='C3S-dues26-0003',
                invoice_date=date(2015, 11, 26),
                invoice_amount=D('74.58'),
                member_id=1,
                membership_no=2,
                email='test@example.com',
            ...
            dues4 = Dues26Invoice(
                invoice_no=4,
                invoice_no_string='C3S-dues26-0004-S',
                invoice_date=date(2015, 11, 27),
                invoice_amount=D('24.85'),
                member_id=1,
                membership_no=2,
            ...
            dues5 = Dues26Invoice(
                invoice_no=5,
                invoice_no_string='C3S-dues26-0005',
                invoice_date=date(2015, 11, 29),
                invoice_amount=D('12.89'),
                member_id=1,
                membership_no=3,
            ...
            dues6 = Dues26Invoice(
                invoice_no=6,
                invoice_no_string='C3S-dues26-0006-S',
                invoice_date=date(2015, 11, 30),
                invoice_amount=D('77.79'),
                member_id=1,
                membership_no=3,
            ...
            member1.set_dues26_payment(D('12.34'), date(2015, 10, 31))
            member2.set_dues26_payment(D('95.65'), date(2015, 11, 5))
            member3.set_dues26_payment(D('-85.12'), date(2015, 11, 30))
    ...
    def test_get_all(self):
        ...
        test get_all
        '''
        res = DuesInvoiceRepository.get_all([2026])
        self.assertEqual(len(res), 6)
    ...
    def test_get_by_invoice_no(self):
        ...
        test get_by_invoice_no
        '''
        res = DuesInvoiceRepository.get_by_number(1, 2026)
        self.assertEqual(res.id, 1)
    ...
    def test_get_monthly_stats(self):
        ...
        Test get_monthly_stats.
        """
        stats = DuesInvoiceRepository.get_monthly_stats(2026)
        self.assertEqual(len(stats), 2)
        self.assertEqual(stats[0]['month'], datetime(2015, 10, 1))
        self.assertAlmostEqual(stats[0]['amount_invoiced_normal'], D('-37.50'))
        self.assertAlmostEqual(
            stats[0]['amount_invoiced_reversal'], D('16.26'))
        self.assertAlmostEqual(stats[0]['amount_paid'], D('12.34'))
        self.assertEqual(stats[1]['month'], datetime(2015, 11, 1))
        self.assertAlmostEqual(stats[1]['amount_invoiced_normal'], D('87.47'))
        self.assertAlmostEqual(
    ...
    def test_decimality(self):
        ...
        def trigger_invalid_operation():
            dues2 = Dues26Invoice(
                invoice_no=5,
                invoice_no_string='C3S-dues26-0002',
                invoice_date=date.today(),
                invoice_amount=str(D('-37.50.20').to_eng_string()),
                member_id=1,
                membership_no=1,
        ...
        # now really store a new Dues26Invoice
        dues3 = Dues26Invoice(
            invoice_no=7,
            invoice_no_string='C3S-dues26-0002',
            invoice_date=date.today(),
