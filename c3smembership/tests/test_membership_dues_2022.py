...
class TestDues22Views(unittest.TestCase):
    ...
    def test_send_dues22_invoice_email_single(self):
        ...
        * english investing legal entity
        ...
        self.assertTrue(
            (u'Mitgliedsbeitrag für das ganze Jahr 2022 beträgt also 50 Euro.')
    ...
    def test_send_dues22_invoice_email_via_BATCH(self):
        ...
        _number_of_invoices_before_batch = len(DuesInvoiceRepository.get_all([2022]))
    ...
    def test_dues22_reduction(self):
        ...
        _number_of_invoices_before_reduction = len(DuesInvoiceRepository.get_all([2022]))
        ...
        self.assertEqual(len(DuesInvoiceRepository.get_all([2022])), 2)  # no new invoice
        ...
        _number_of_invoices_after_reduction = len(DuesInvoiceRepository.get_all([2022]))
