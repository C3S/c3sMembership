...
class TestDues18Views(unittest.TestCase):
    ...
    def test_send_dues18_invoice_email_via_BATCH(self):
        ...
        i2 = DuesInvoiceRepository.get_by_number(2018, 2)
        ...
        i1 = DuesInvoiceRepository.get_by_number(2018, 1)
    ...
    def test_dues18_reduction(self):
        ...
        _rev_inv = DuesInvoiceRepository.get_by_number(
            2018, _number_of_invoices_before_reduction + 1)
        _new_inv = DuesInvoiceRepository.get_by_number(
            2018, _number_of_invoices_before_reduction + 2)
