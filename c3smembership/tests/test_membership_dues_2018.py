...
>>>>>>> Stashed changes
    ...
    def test_dues18_reduction_pdf(self):
        """
        test the dues18_reduction functionality end-to-end,
        ...
        res = send_dues18_invoice_batch(req)
        res
        i2 = Dues18Invoice.get_by_invoice_no(1)
        req.referrer = 'toolbox'
        i2.token = m2.dues18_token  # we give it a valid token
        req.matchdict = {
            'email': m2.email,
        ...
        res = make_dues18_reversal_invoice_pdf(req)
