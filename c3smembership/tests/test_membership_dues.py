...
class MembershipDuesIntegration(IntegrationTestCaseBase):
    ...
    def test_send_invoice_email_iv(self):
        ...
        self.normal_de.dues22_invoice = False
        db_session.flush()

        response = self._send_invoice(1234)

        self.assertFalse(self.normal_de.dues22_invoice)
    ...
    def test_send_invoice_email_bv(self):
        ...
        self.assertTrue(self.normal_de.dues22_invoice)
        ...
        self.assert_flash(
            response, 'warning',
            'Member 1 was not a member in 2022. Therefore, the member is not '
            'applicable for dues in 2022.')
        ...
        self.log_out()
        response = self.testapp.get('/dues22_invoice/1', status=403)
    ...
    def test_send_invoice_email_bl(self):
        ...
        self.assertTrue(self.normal_de.dues22_invoice)
        self.assertEqual(self.normal_de.dues22_invoice_date.date(),
                         date.today())
        ...
        self.assertTrue(self.investing_de.dues22_invoice)
        self.assertEqual(self.investing_de.dues22_invoice_date.date(),
                         date.today())
        ...
        # 1.1 Calculate quarterly dues
        self.assertEqual(self.normal_de.dues22_amount, Decimal('50.0'))

        # 1.2 Store dues data
        self.assertTrue(self.normal_de.dues22_invoice)
        self.assertEqual(self.normal_de.dues22_invoice_date.date(),
                         date.today())
        self.assertIsNotNone(self.normal_de.dues22_invoice_no)
        self.assertIsNotNone(self.normal_de.dues22_token)
        self.assertEqual(self.normal_de.dues22_start, 'q1_2022')
        self.assertFalse(self.normal_de.dues22_reduced)
        self.assertTrue(self.normal_de.dues22_amount_reduced.is_nan())
        self.assertEqual(self.normal_de.dues22_balance, Decimal('50.0'))
        self.assertFalse(self.normal_de.dues22_balanced)
        self.assertFalse(self.normal_de.dues22_paid)
        self.assertEqual(self.normal_de.dues22_amount_paid, Decimal('0.0'))
        self.assertIsNone(self.normal_de.dues22_paid_date)

        # 1.3 Store invoice data
        invoice = db_session.query(Dues22Invoice).filter(
            Dues22Invoice.member_id == 1).first()
        ...
        self.assertTrue('/dues22_invoice_no/{}/C3S-dues22-'.format(
            self.normal_en.dues22_token) in message.body)
        ...
        self.assertTrue('/dues22_invoice_no/{}/C3S-dues22-'.format(
            self.normal_de.dues22_token) in message.body)
        ...
        self.assertTrue('You will find the invoice here:' in message.body)
        self.assertTrue('/dues22_invoice_no/{}/C3S-dues22-'.format(
            self.normal_fr.dues22_token) in message.body)
        ...
        self._mock_mailer()
        self._reset_member(self.normal_en)
        self.assertFalse(self.normal_en.dues22_invoice)
        self.assertIsNone(self.normal_en.dues22_invoice_date)

        self._send_invoice(self.normal_en.id)

        self.assertTrue(self.normal_en.dues22_invoice)
        self.assertEqual(self.normal_en.dues22_invoice_date.date(),
                         date.today())

        # 4.2 For investing members
        self._mock_mailer()
        self._reset_member(self.investing_en)
        self.assertFalse(self.investing_en.dues22_invoice)
        self.assertIsNone(self.investing_en.dues22_invoice_date)

        self._send_invoice(self.investing_en.id)

        self.assertTrue(self.investing_en.dues22_invoice)
        self.assertEqual(self.investing_en.dues22_invoice_date.date(),
                         date.today())
        ...
        self._send_invoice(self.normal_en.id)
        self.assertEqual(self.normal_en.dues22_amount, Decimal('50.0'))
        self.assertEqual(self.normal_en.dues22_start, 'q1_2022')
    ...
    def _send_invoice(self, member_id):
        ...
        """
        response = self.testapp.get('/dues22_invoice/{}'.format(member_id),
    ...
    def _reset_member(self,
        ...
        member.dues22_invoice = False
        member.dues22_invoice_date = None
